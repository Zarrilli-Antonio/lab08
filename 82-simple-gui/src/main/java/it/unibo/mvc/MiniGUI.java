...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JButton randomButton = new JButton("Print a random number on standard output");
        panel.add(randomButton, BorderLayout.CENTER);
        //Part 2
        ...
        randomButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                Integer randomNumber = randomGenerator.nextInt();
                System.out.println(randomNumber);
                resultField.setText(String.valueOf(randomNumber));
            }
        });
    }
